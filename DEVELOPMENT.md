...
```bash
git remote add encore encore://neurova-ai-operating-system-tmfi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/neurova-ai-operating-system-tmfi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/neurova-ai-operating-system-tmfi/settings/integrations/github)
