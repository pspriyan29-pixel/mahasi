                        ...
                        <div className="glass-strong rounded-xl sm:rounded-2xl p-4 sm:p-6">
                            ...
                            <div className="relative mb-4">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 sm:pl-12 pr-4 py-3 glass-strong rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 text-base"
                                />
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full px-3 sm:px-4 py-3 glass-strong rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm sm:text-base"
                                    >
